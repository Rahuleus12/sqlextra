-- Azure SQL Edge compatible version
USE master;
GO
...
('EMP1', '111', '2024-01-01', 0, 1000.00, 0, 'CWO'),
('EMP1', '111', '2024-01-01', 0, 200.00, 0, NULL),
('EMP1', '111', '2024-01-01', 500.00, 0, 0, NULL),

-- Test case 2: Single account, transactions on different dates
('EMP2', '222', '2024-01-01', 0, 2000.00, 0, 'CWO'),
('EMP2', '222', '2024-01-02', 300.00, 0, 0, NULL),
('EMP2', '222', '2024-01-03', 0, 500.00, 0, NULL),

-- Test case 3: Multiple accounts with overlapping dates
('EMP3', '333', '2024-01-01', 0, 3000.00, 0, 'CWO'),
('EMP3', '333', '2024-01-02', 1000.00, 0, 0, NULL),
('EMP4', '444', '2024-01-01', 0, 5000.00, 0, 'CWO'),
('EMP4', '444', '2024-01-02', 2000.00, 0, 0, NULL);
GO
